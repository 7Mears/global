<?php
/**
 * Global Exteriors Theme Customizer
 *
...
function global_customize_preview_js() {
	wp_enqueue_script( 'global_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
